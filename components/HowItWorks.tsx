                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            ...
                            {/* CTA link — only shown when translation key has a value */}
                            {t('cta') && (
                                <div className={`mt-8 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
                                    style={{ transitionDelay: '900ms' }}>
                                    <a href="https://DigitalDreamWorksAgency.com" target="_blank" rel="noopener noreferrer"
