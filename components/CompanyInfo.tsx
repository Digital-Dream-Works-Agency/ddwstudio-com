                        ...
                        <div className="relative">
                            ...
                            <div className="glass-card p-8">
                                <div className="grid grid-cols-2 gap-6">
                                    <div>
                                        <div className="text-3xl font-bold text-gradient-vibrant font-display mb-1">{t('stats.saasProductsValue')}</div>
                                        <div className="text-sm text-zinc-500">{t('stats.saasProducts')}</div>
                                    </div>
                                    <div>
                                        <div className="text-3xl font-bold text-gradient-vibrant font-display mb-1">{t('stats.aiOpsValue')}</div>
                                        <div className="text-sm text-zinc-500">{t('stats.aiOps')}</div>
                                    </div>
                                    <div>
                                        <div className="text-3xl font-bold text-gradient-vibrant font-display mb-1">{t('stats.certifiedValue')}</div>
                                        <div className="text-sm text-zinc-500">{t('stats.certified')}</div>
                                    </div>
                                    <div>
                                        <div className="text-3xl font-bold text-gradient-vibrant font-display mb-1">{t('stats.uptimeSlaValue')}</div>
