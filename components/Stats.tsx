...
function StatItem({ value, label, suffix = '', prefix = '', delay }: StatItemProps) {
    ...
    return (
        ...
        >
            <div className="text-5xl md:text-6xl font-bold font-display text-gradient mb-3">
...
export default function Stats() {
    ...
    return (
        <section ref={sectionRef} className="w-full relative py-32 overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-accent-900/15 to-transparent"></div>
