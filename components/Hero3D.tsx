    ...
    return (
        <section ref={heroRef} className="w-full relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                {/* Large Gradient Orbs */}
                <div
                    className="absolute top-1/4 left-1/4 w-[600px] h-[600px] gradient-orb bg-accent-400/15"
                    style={{
                ...
                ></div>
                <div
                    className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] gradient-orb bg-accent-600/15"
                    style={{
                ...
                >
                    <div className="w-full h-full rounded-2xl bg-gradient-to-br from-accent-400/30 to-accent-700/10 border border-white/10 backdrop-blur-sm"></div>
                </div>
                ...
                >
                    <div className="w-full h-full rounded-xl bg-gradient-to-br from-accent-300/25 to-accent-500/10 border border-white/10 backdrop-blur-sm"></div>
                </div>
                ...
                >
                    <div className="w-full h-full rounded-lg bg-gradient-to-br from-accent-200/20 to-accent-600/10 border border-white/10 backdrop-blur-sm"></div>
                </div>
                ...
                {[...Array(6)].map((_, i) => (
                    <div
                        key={i}
                        className="absolute w-2 h-2 rounded-full bg-accent-400/40 animate-float-slow"
                        style={{
                            top: `${20 + i * 15}%`,
                            left: `${10 + i * 15}%`,
            ...
            >
                <div className="flex flex-col items-center gap-2 text-zinc-500">
                    ...
                    <div className="w-6 h-10 rounded-full border-2 border-zinc-700 flex justify-center pt-2">
                        <div className="w-1.5 h-3 bg-gradient-to-b from-accent-400 to-accent-700 rounded-full animate-bounce"></div>
                    </div>
                </div>
            </div>
        </section>
