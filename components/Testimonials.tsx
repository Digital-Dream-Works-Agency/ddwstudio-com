...
// Testimonial visual config — gradient colors per card
const testimonialVisuals = [
    { key: 'testimonial1', gradient: 'from-violet-500 to-purple-600' },
    { key: 'testimonial2', gradient: 'from-blue-500 to-cyan-500' },
    { key: 'testimonial3', gradient: 'from-emerald-500 to-teal-500' },
];
            ...
            <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    {testimonialVisuals.map((testimonial, index) => {
                        const authorName = t(`${testimonial.key}.author`);
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4">
                                {/* Avatar with initials derived from author name */}
