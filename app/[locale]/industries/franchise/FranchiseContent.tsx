...
import { AlertTriangle, BarChart2, FileX, Globe, Eye, CheckSquare, ChevronRight } from 'lucide-react';
...
const painPoints = [
    {
        icon: AlertTriangle,
        title: 'Each Location Runs Differently',
        description: 'Without standardized systems, every location develops its own processes, pricing, and customer experience. Brand consistency suffers and ops escalations flood corporate.',
    },
    {
        icon: BarChart2,
        title: 'No Real-Time Visibility',
        description: 'Getting accurate performance data from 30+ locations requires manual reports, delay, and inconsistency. By the time you see the data, the problem is already a crisis.',
    },
    {
        icon: FileX,
        title: 'Compliance Is a Manual Nightmare',
        description: 'Tracking compliance across dozens of locations — health inspections, licensing, training certifications — is impossible to manage manually at scale.',
    },
];
...
const solutions = [
    {
        icon: Globe,
        title: 'Centralized Agentic Operations System',
        description: 'One AI-powered platform that standardizes processes, communications, and reporting across every location — ensuring brand consistency at scale.',
    },
    {
        icon: Eye,
        title: 'Real-Time Multi-Location Dashboard',
        description: 'See performance, compliance status, and operational metrics for every location in one unified dashboard — updated in real-time, no manual reporting needed.',
    },
    {
        icon: CheckSquare,
        title: 'Automated Compliance Monitoring',
        description: 'Automated compliance tracking, certification alerts, and audit documentation for every location — ensuring you\'re always ready for an inspection.',
    },
];

const stats = [
    { number: 'All', label: 'Locations Unified' },
    { number: '90%', label: 'Fewer Ops Escalations' },
    { number: 'Real-Time', label: 'Visibility' },
    { number: 'Standardized', label: 'Compliance' },
];
        ...
        <>
            ...
            <main className="min-h-screen bg-black overflow-hidden pt-32 pb-24">
                ...
                <div className="fixed top-0 right-0 w-[700px] h-[700px] rounded-full opacity-10 pointer-events-none"
                    style={{ background: 'radial-gradient(circle, rgba(168,85,247,0.3), transparent 70%)' }}></div>
                ...
                <section className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 mb-32">
                    <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl">
                        ...
                        <motion.h1 variants={fadeUp} className="text-5xl sm:text-6xl font-bold text-white font-display mb-8 tracking-tight leading-tight">
                            30 Locations Means 30 Operational Problems.{' '}
                            <span className="bg-gradient-to-r from-purple-400 to-[#618DC7] bg-clip-text text-transparent">
                                Unless You Automate the Routine.
                            </span>
                        </motion.h1>
                        <motion.p variants={fadeUp} className="text-xl text-zinc-400 leading-relaxed mb-10 max-w-2xl">
                            One centralized agentic system that standardizes operations, ensures compliance, and gives you real-time visibility across every location.
                        </motion.p>
                ...
                <section className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 mb-32">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
                        <motion.div variants={fadeUp} className="text-center mb-16">
                            ...
                            <h2 className="text-4xl sm:text-5xl font-bold text-white font-display">Why Franchise Ops Break at Scale</h2>
                        </motion.div>
                ...
                <section className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 mb-32">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
                        <motion.div variants={fadeUp} className="text-center mb-16">
                            ...
                            <h2 className="text-4xl sm:text-5xl font-bold text-white font-display">One System. All Locations.</h2>
                        </motion.div>
                        <div className="grid md:grid-cols-3 gap-8">
                            {solutions.map((sol, i) => {
                                const Icon = sol.icon;
                ...
                <section className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}
                        ...
                        <h2 className="text-4xl sm:text-5xl font-bold text-white font-display mb-6">
                            Ready to Bring Your Franchise Under One System?
                        </h2>
                        <p className="text-zinc-400 text-lg mb-10 max-w-2xl mx-auto">
                            Book a free Discovery Call. We'll map your current multi-location operations and show you exactly how centralization delivers ROI.
                        </p>
