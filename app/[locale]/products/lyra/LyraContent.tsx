                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            ...
                            >
                                ...
                                <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 mb-12">
                                    ...
                                    <a href="https://lyrabyddw.com" target="_blank" rel="noopener noreferrer" className="btn-secondary">
                                        {t('hero.learnMore')}
                                    </a>
                                </motion.div>
                            ...
                            {[
                                ...
                                >
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <h3 className="text-2xl font-bold text-white mb-4 tracking-tight group-hover:text-zinc-300 transition-colors duration-300">
